...
const pagoRealizadoSchema = z.object({
  ...
  metodoPago: z
    .string()
    .min(1, { message: "El método de pago es obligatorio" }),
  ...
  comprobante: z.any().optional().nullable(), // Cambiado para aceptar archivos
  observaciones: z.string().optional().nullable(),
});

export default function FormularioPagoRealizado({
  pago,
  onSubmit,
  isSubmitting = false,
  onCancel,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-foreground">
                    {format(new Date(pago.fechaVencimiento), "PPP", {
                      locale: es,
                    })}
                  </span>
                </div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="app">
                      📱 Aplicación Móvil (Yape, Plin, etc.)
                    </SelectItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Ej: BCP, Interbank, BBVA, etc."
                    {...field}
                    value={field.value || ""}
                  />
                </FormControl>
