      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm">
                Feriados en {format(currentDate, "MMMM", { locale: es })}
              </CardTitle>
            </CardHeader>
            <CardContent>
              {(() => {
                const feriadosDelMes = feriadosDelAño.filter(
                  (feriado) =>
                    feriado.fecha.getMonth() === currentDate.getMonth() &&
                    feriado.fecha.getFullYear() === currentDate.getFullYear()
                );
                  ...
                  <div className="space-y-2">
                    {feriadosDelMes.map((feriado, index) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="font-medium">
                            {format(feriado.fecha, "d 'de' MMMM", {
                              locale: es,
                            })}
                          </p>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="flex justify-between text-xs">
                ...
                <span className="font-medium text-green-600">
                  {estadisticasMes.diasLaborables}
                </span>
              </div>
              <div className="flex justify-between text-xs">
                <span>Feriados:</span>
                <span className="font-medium text-red-600">
                  {estadisticasMes.diasFeriados}
                </span>
              </div>
              <div className="flex justify-between text-xs">
                <span>Fin de semana:</span>
                <span className="font-medium text-blue-600">
                  {estadisticasMes.diasFinSemana}
                </span>
              </div>
              <div className="flex justify-between text-xs">
